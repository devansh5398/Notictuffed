          ...
          if(!empty($_POST['next1'])) {
            ...
            if(empty($_POST['usermail']))
              ...
              if(!filter_var($usermail, FILTER_VALIDATE_EMAIL))
                $sql = "SELECT FIRSTNAME, LASTNAME, EMAIL FROM users WHERE USERNAME = '$usermail'";
              else
                $sql = "SELECT FIRSTNAME, LASTNAME, EMAIL FROM users WHERE EMAIL = '$usermail'";
  ...
  <body style="background-color:#ECEFF1;">
    ...
    <div style="background-color:white;" class="col-lg-4 col-md-5 col-sm-6 p-5 mx-auto mt-5 mb-sm-5 shadow-sm rounded">
      ...
      <div class="forgot_pass connOne collapse">
        ...
        <br>
        <div class="clearfix">
          <span class="float-left"><a href="student_signin.php">Sign in</a></span>
