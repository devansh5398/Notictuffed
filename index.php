  ...
  <body style="background-color:#ECEFF1;">
    ...
    <div class="intro p-3">
      <div class="intro_img col-md-9 col-sm-10 p-0 mx-auto mt-3 text-center">
        <img class="logo" src="logo.png" alt="Notictuffed logo"><br>
        <h1 style="font-family: 'Permanent Marker', 'Times New Roman', cursive; font-size: 3rem; color: #204969; text-shadow: 0 0 1rem #8ac6d1;">Notictuffed</h1>
      </div><br>
      <div style="font-family: 'Caveat', 'Times New Roman', cursive; font-size: 1.5rem;" class="intro_body col-lg-8 col-md-9 col-sm-10 p-0 mx-auto">
        ...
        <div class="l3 bg-danger text-white rounded px-3">So, get started by <strong><a href="sighup.php" style="text-decoration:none; color:#293462">Signing up</a></strong>
